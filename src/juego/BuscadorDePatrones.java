...
public class BuscadorDePatrones {
	 ...
	 * 
	 * @param coordenadaColumna
	 *            : posición de la ficha en columna
	 * @param coordenadaFila
	 *            : posición de la ficha en fila
	 * @return True en caso de cumplirse la condición dada.
	 */
	private boolean estaDentroDeLosLimitesDelTablero(int coordenadaColumna,
			int coordenadaFila) {
	...
	/**
	 * pre : Existe un tablero y existen más de 6 fichas en el mismo (3 de cada
	 * jugador). post: Busca fichas compañeras en dirección izquierda.
	 */

	private void buscarFichasHaciaLaIzquierda() {

		columnaDesplazada = coordenadaColumna - 1;

		while (fichasEncontradas < 4
				&& estaDentroDeLosLimitesDelTablero(columnaDesplazada,
						coordenadaFila)
				&& tablero[columnaDesplazada][coordenadaFila] == colorCasillero) {
	...
	/**
	 * pre : Existe un tablero y existen más de 6 fichas en el mismo (3 de cada
	 * jugador). post: Busca fichas compañeras en dirección derecha.
	 */
	...
	/**
	 * pre : Existen más de 6 fichas en el tablero. post: Analiza los laterales
	 * de la última ficha lanzada en búsqueda de fichas compañeras.
	 * 
	...
	/**
	 * pre : Existe un tablero y existen más de 6 fichas en el mismo (3 de cada
	 * jugador). post: Busca fichas compañeras hacia abajo.
	 */

	private void buscarFichasHaciaAbajo() {

		filaDesplazada = coordenadaFila + 1;

		while (fichasEncontradas < 4
				&& estaDentroDeLosLimitesDelTablero(coordenadaColumna,
						filaDesplazada)
				&& tablero[coordenadaColumna][filaDesplazada] == colorCasillero) {
	...
	/**
	 * pre : La cuarta fila tiene al menos una ficha soltada. post: Busca hacia
	 * abajo Fichas compañeras en la periferia de la última ficha lanzada.
	 * 
	 * @return True en caso de encontrarse 4 fichas compañeras.
	 */
	...
	/**
	 * pre : Existe un tablero y existen más de 6 fichas en el mismo (3 de cada
	 * jugador). post: Busca fichas compañeras hacia arriba a la izquierda
	 * (diagonal ascendente).
	 */
	private void buscarFichasHaciaArribaALaIzquierda() {
		...
		while (fichasEncontradas < 4
				&& estaDentroDeLosLimitesDelTablero(columnaDesplazada,
						filaDesplazada)
				&& tablero[columnaDesplazada][filaDesplazada] == colorCasillero) {
	...
	/**
	 * post: Busca fichas compañeras hacia abajo a la derecha (diagonal
	 * descendente).
	 */
	 ...
	 * 
	 * pre : En direcciones abajo-derecha o abajo-izquierda hay al menos 3 (4
	 * contando a la última Ficha lanzada) columnas que la separen de los
	 * márgenes laterales del Tablero. post: Devuelve valor de verdad en caso de
	 * hallarse el patrón indicado.
	 * 
	 * @return True en caso de encontrarse 4 fichas compañeras.
	 */
	...
	/**
	 * post: Busca fichas compañeras hacia arriba a la derecha (diagonal
	 * ascendente).
	 */
	...
	/**
	 * post: Busca fichas compañeras hacia abajo a la izquierda (diagonal
	 * descendente).
	 */
	 ...
	 * lanzada Fichas compañeras.
	 * 
	 * pre : En direcciones arriba-derecha o arriba-izquierda hay al menos 3 (4
	 * contando a la última Ficha lanzada) columnas que la separen de los
	 * márgenes laterales del Tablero. post: Devuelve valor de verdad en caso de
	 * hallarse el patrón indicado.
	 * 
	 ...
	 * 
	 * post: Devuelve valor de verdad en caso de hallarse uno de los patrones
	 * que indican fin del juego.
	 * 
	...
	public boolean hayCuatroEnLinea(Coordenada coordenadaUltimaFichaTirada,
		...
		return hayPatronHorizontal() || hayPatronVertical()
				|| hayPatronDiagonalDescendente()
				|| hayPatronDiagonalAscendente();
	}
}